...
export const meta = {
  ...
  endCard: {
    ...
    blurb: "Everything here is the free tier. Adding the Voygent connector in claude.ai is one click. This walk-through is scripted, a real run pulls live results.",
  },
  recap: [
