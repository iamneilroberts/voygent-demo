...
export const meta = {
  ...
  endCard: {
    ...
    blurb: "A free account takes about a minute. Sign up at voygent.ai, add the Voygent custom connector in claude.ai, and start planning. This walk-through was scripted, a real run pulls live results.",
  },
